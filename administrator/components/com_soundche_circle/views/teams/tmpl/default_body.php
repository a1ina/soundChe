...
<?php foreach ($this->items as $i => $item): ?>
    ...
    <tr class="row<?php echo $i % 2; ?>">
        ...
        <td>
            <?php
            echo JHtml::_('jgrid.published',$item->published,$i,'teams.');
            //echo $published; ?>
        </td>
      ...
      <a href="<?php echo JRoute::_('index.php?option=com_soundche_circle&task=team.edit&id='. (int) $item->id) ?>">
        ...
        <td>
            <?php echo JHTML::_('image', $item->joke_photo, 'JOKE_PHOTO', 'height="80" width="80"'); ?>
        </td>
        <td>
