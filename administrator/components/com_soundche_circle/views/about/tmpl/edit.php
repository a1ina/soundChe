...
<form class="form-validate"
    ...
    <div class="width-60 fltlft">
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_SOUNDCHE_ABOUT_DETAILS'); ?></legend>
        ...
        <div>
            <input type="hidden" name="task" value="about.edit"/>
...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            ...
            {
                if (task == 'about.cancel') {
                    Joomla.submitform(task, document.getElementById('circlesoundche-form'));
                }
                else{

                    if (task != 'about.cancel' && document.formvalidator.isValid(document.id('circlesoundche-form'))) {
