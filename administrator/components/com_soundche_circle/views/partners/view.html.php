...
class Soundche_circleViewPartners extends JView
{
   ...
   public function display($tpl = null)
    ...
    protected function addToolBar () {
        ...
        JToolBarHelper::addNewX('partner.add');
        JToolBarHelper::editList('partner.edit');
        JToolBarHelper::divider();
        JToolBarHelper::title(JText::_('COM_SOUNDCHE_CIRCLE_PARTNER_TITLE'));
        JToolBarHelper::publish('partners.publish'); // Will call the task/function "publish" in your controller
        JToolBarHelper::unpublish('partners.unpublish');
