...
?>
<form action="<?php echo JRoute::_('index.php?option=com_soundche_circle&view=about'); ?>" method="post" name="adminForm" id="adminForm">
...
<!--        --><?php //echo JHtml::_('select.options', JHtml::_('access.assetgroups'),value,'text',$this->state->get('filter.access'),true);?><!--</select>-->
    ...
    <div>
        ...
        <input type="hidden" name="view" value="abouts" />
