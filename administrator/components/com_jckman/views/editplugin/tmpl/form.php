...
<div class="col width-60">
	...
	<table class="admintable">
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="35" value="<?php echo $this->plugin->title; ?>" disabled="disabled"/>
			</td>
		</tr>
		<tr>
			<td width="100" class="key">
			...
			<td>
				<input class="text_area" type="text" name="description" id="description" size="35" value="<?php echo $this->plugin->description; ?>" disabled="disabled" />
			</td>
		</tr>
		<tr>
