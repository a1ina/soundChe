...
//                $image_background_shadow = $paramsC->get('image_background_shadow', 'shadow1');
                ...
                $enable_switch = 0;
                $display_comment_img = $paramsC->get('display_comment_img ', 1);
                ...
                foreach ($parts as $key => $value) {
                    ...
                    if ($values[0] == 'view') {
                        $view = $values[1];
                    } else if ($values[0] == 'categoryid') {
                        $catid = $values[1];
                    } else if ($values[0] == 'imageid') {
                        $imageid = $values[1];
                    } else if ($values[0] == 'imagerandom') {
                        $imagerandom = $values[1];
                    } else if ($values[0] == 'imageshadow') {
                        $image_background_shadow = $values[1];
                    } else if ($values[0] == 'limitstart') {
                        $limitstart = $values[1];
                    } else if ($values[0] == 'limitcount') {
                        $limitcount = $values[1];
                    } else if ($values[0] == 'detail') {
                        $tmpl['detailwindow'] = $values[1];
                    } else if ($values[0] == 'displaycommentimg') {
                        $display_comment_img = $values[1];
                    } else if ($values[0] == 'displayname') {
                        $display_name = $values[1];
                    } else if ($values[0] == 'displaydetail') {
                        $display_icon_detail = $values[1];
                    } else if ($values[0] == 'displaydownload') {
                        $display_icon_download = $values[1];
                    } else if ($values[0] == 'displaybuttons') {
                        $detail_buttons = $values[1];
                    } else if ($values[0] == 'displayratingimg') {
                        $tmpl['displayratingimg'] = $values[1];
                    } else if ($values[0] == 'namefontsize') {
                        $namefontsize = $values[1];
                    } else if ($values[0] == 'namenumchar') {
                        $namenumchar = $values[1];
                    } else if ($values[0] == 'displaydescription') {
                        $display_description = $values[1];
                    } else if ($values[0] == 'descriptionheight') {
                        $description_height = $values[1];
                    } else if ($values[0] == 'hidecategories') {
                        $hide_categories = $values[1];
                    } else if ($values[0] == 'boxspace') {
                        $category_box_space = $values[1];
                    } // CSS
                    else if ($values[0] == 'fontcolor') {
                        $font_color = $values[1];
                    } else if ($values[0] == 'bgcolor') {
                        $background_color = $values[1];
                    } else if ($values[0] == 'bgcolorhover') {
                        $background_color_hover = $values[1];
                    } else if ($values[0] == 'imagebgcolor') {
                        $image_background_color = $values[1];
                    } else if ($values[0] == 'bordercolor') {
                        $border_color = $values[1];
                    } else if ($values[0] == 'bordercolorhover') {
                        $border_color_hover = $values[1];
                    } else if ($values[0] == 'hsclass') {
                        $highslide_class = $values[1];
                    } else if ($values[0] == 'hsopacity') {
                        $highslide_opacity = $values[1];
                    } else if ($values[0] == 'hsoutlinetype') {
                        $highslide_outline_type = $values[1];
                    } else if ($values[0] == 'hsfullimg') {
                        $highslide_fullimg = $values[1];
                    } else if ($values[0] == 'hsslideshow') {
                        $highslide_slideshow = $values[1];
                    } else if ($values[0] == 'hsclosebutton') {
                        $highslide_close_button = $values[1];
                    } else if ($values[0] == 'float') {
                        $float = $values[1];
                    } else if ($values[0] == 'jakslideshowdelay') {
                        $tmpl['jakslideshowdelay'] = $values[1];
                    } else if ($values[0] == 'jakorientation') {
                        $tmpl['jakorientation'] = $values[1];
                    } else if ($values[0] == 'jakdescription') {
                        $tmpl['jakdescription'] = $values[1];
                    } else if ($values[0] == 'jakdescriptionheight') {
                        $tmpl['jakdescriptionheight'] = $values[1];
                    } else if ($values[0] == 'imageordering') {
                        $tmpl['imageordering'] = $values[1];
                    } else if ($values[0] == 'pluginlink') {
                        $tmpl['pluginlink'] = $values[1];
                    } else if ($values[0] == 'highslidedescription') {
                        $tmpl['highslidedescription'] = $values[1];
                    } else if ($values[0] == 'type') {
                        $plugin_type = $values[1];
                    } else if ($values[0] == 'paddingmosaic') {
                        $padding_mosaic = $values[1];
                    } else if ($values[0] == 'minboxwidth') {
                        $minimum_box_width = $values[1];
                    } //Image categories
                    else if ($values[0] == 'imagecategories') {
                        $img_cat = $values[1];
                    } else if ($values[0] == 'imagecategoriessize') {
                        $img_cat_size = $values[1];
                    } else if ($values[0] == 'switchwidth') {
                        $switch_width = $values[1];
                    } else if ($values[0] == 'switchheight') {
                        $switch_height = $values[1];
                    } else if ($values[0] == 'basicimageid') {
                        $basic_image_id = $values[1];
                    } else if ($values[0] == 'enableswitch') {
                        $enable_switch = $values[1];
                    } else if ($values[0] == 'switchfixedsize') {
                        $switch_fixed_size = $values[1];
                    } else if ($values[0] == 'piclens') {
                        $enable_piclens = $values[1];
                    } else if ($values[0] == 'overlib') {
                        $enable_overlib = $values[1];
                    } else if ($values[0] == 'enablecustomcss') {
                        $tmpl['enablecustomcss'] = $values[1];
                    }
                }
			...
			window.addEvent(\'domready\', function(){
				...
				*/
                ...
                // ===============================
                $output = '';
                $output .= '<div class="phocagallery  carousel-items">' . "\n";
                    ...
                    foreach ($category as $image) {
                        ...
                        switch ($plugin_type) {
                            ...
                            default:
                                ...
                                $imageHeight['boxsize'] = PhocaGalleryImage::setBoxSize($imageHeight, $imageWidth, $display_name, $display_comment_img, $display_icon_detail, $display_icon_download, 0, 0, 0, 0, 0, 0, 0, 0, $category_box_space, $image_background_shadow, 0);
                                ...
                                $output .= '<div class="phocagallery-box-file pgplugin  carousel-block ' . $iCss . '" style="height:210px; width:160px;' . $float_code . 'margin: ' . $margin_box . 'px;padding: ' . $padding_box . 'px;">' . "\n"
                                    . '<center>' . "\n"
                                    . '<div class="phocagallery-box-file-first  " style="' . $imageBgCSSIE . 'height:150px; width: 150px;">' . "\n"
	...
	*/
	...
	if ($enable_overlib == 6 && isset($items[$iS]->usernameno) && $items[$iS]->usernameno != '') {
		$uBy = '<div>' . JText::_('COM_PHOCAGALLERY_UPLOADED_BY') . ' <strong>'.$items[$iS]->usernameno.'</strong></div>';
                                ...
                                if ($display_icon_detail == 1 || $display_icon_download > 0 || $display_comment_img == 1 || $enable_piclens == 2) {
                                    ...
                                    $document->addScript('/components/com_phocagallery/assets/js/highslide/highslide-full.js');
                                    $document->addStyleSheet('/components/com_phocagallery/assets/js/highslide/highslide.css');


                                    if ($display_comment_img == 1) {

                                        $output .= ' <a  class="highslide button comment" title="' . JText::_('COM_PHOCAGALLERY_COMMENT_IMAGE') . '"'
                                            . ' href="' . JRoute::_('index.php?option=com_phocagallery&view=comment&catid=' . $image->catid . '&id=' . $image->id . '&tmpl=component&Itemid=' . JRequest::getVar('Itemid', 0, '', 'int')) . '"';
                                        $output .= 'onclick="return hs.htmlExpand(this, phocaZoom )"';
                                        $output .= ' >';
                                        $output .= '<span>';
                                        $output .= 'Коментувати';
                                        $output .= '</span>';
                                        $output .= JHtml::_('image', 'components/com_phocagallery/assets/images/comment-icon.png', JText::_('COM_PHOCAGALLERY_COMMENT_IMAGE'), 'height=20 width=20');
                                        $output .= '</a>';
                                    }
