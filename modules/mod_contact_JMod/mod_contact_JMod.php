...
=================================================================*/
  ...
  <div class="contact_form <?php echo $mod_class_suffix; ?>">
	...
	<div style="color:#E0E0E0;margin-bottom:3px;font-size:8px"><a style="text-decoration:none" target="_blank" class="external" href="http://www.lefkada-rooms.com/"><span style="color:#E0E0E0;margin-bottom:3px;font-size:8px">lefkada-rooms.com</span></a></div>
  </div>
  <?php  return true; ?>