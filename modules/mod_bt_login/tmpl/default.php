...
<div id="btl">
	...
	<div class="btl-panel">
		<?php if($type == 'logout') : ?>
		<!-- Profile button -->
        <li>	<span id="btl-panel-profile" class="btl-dropdown button">
        ...
        <ul>
            ...
            if($enabledRegistration){
                ...
                if($option!='com_user' && $task != 'register' ){
                    ?>
                    <a id="btl-panel-registration" class="<?php echo $effect;?> button b_reg"><?php echo JText::_('JREGISTER');?></a>
                    </li>
           <li>
			<!-- Login button -->
			<a id="btl-panel-login" class="<?php echo $effect;?> button in margin_minus" ><?php echo JText::_('JLOGIN');?></a>
			</li>
...
if(btlOpt.ALIGN == "center"){
	...
	BTLJ(".btl-panel").css('float','right');
}
