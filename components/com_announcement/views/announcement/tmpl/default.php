...
$doc->setMetaData('description', mb_substr($this->item->description, 0, 300));
...
<?php if ($this->item) : ?>
    ...
    <div class="content">
        ...
        <ul class="c_marg">
            ...
            <li>
                <a class="event" href="#"><img itemprop="image" src="<?php echo $this->item->image; ?>"
                                               alt="image of event"></a>
            ...
            <li>
                ...
                echo JComments::show($this->item->id, 'com_announcement', $this->item->title);
