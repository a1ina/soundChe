...
?>
<h3><?php echo JText::_('FORM_HEADER'); ?></h3>
<?php
		if ($this->getVar( 'comments-form-policy', 0) == 1) {
?>
<div class="comments-policy notice"><p class="info"><?php echo $this->getVar( 'comments-policy' ); ?></p></div>
<?php
		}
?>
...
<p>
	<span>
		<input id="comments-form-name" class="inputbox" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
...
<p>
	<span>
		<input id="comments-form-email" class="inputbox" type="text" name="email" value="" size="22" tabindex="2" />
...
<p>
	<span>
		<input id="comments-form-homepage" class="inputbox" type="text" name="homepage" value="" size="22" tabindex="3" />
...
<p>
	<span>
		<input id="comments-form-title" class="inputbox" type="text" name="title" value="" size="22" tabindex="4" />
...
<p>
	<span>
		<textarea id="comments-form-comment" class="inputbox" name="comment" cols="65" rows="8" tabindex="5"></textarea>
	</span>
</p>
<?php
...
<p>
	<span>
		...
		<span class="captcha icon-refresh" onclick="jcomments.clear('captcha');">&nbsp;<?php echo JText::_('FORM_CAPTCHA_REFRESH'); ?></span><br />
...
<div id="comments-form-buttons">
	...
	<div id="comments-form-cancel" style="display:none;"><a class="button" href="#" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><?php echo JText::_('FORM_CANCEL'); ?></a></div>
