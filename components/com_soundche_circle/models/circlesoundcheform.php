 ...
 */
class Soundche_circleModelCirclesoundcheForm extends JModelForm
{
	...
	public function &getData($id = null)
	{
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
                ...
                $id = $table->id;
                if($id){
	$canEdit = $user->authorise('core.edit', 'com_soundche_circle.circlesoundche.'.$id) || $user->authorise('core.create', 'com_soundche_circle.circlesoundche.'.$id);
}
else{
	$canEdit = $user->authorise('core.edit', 'com_soundche_circle') || $user->authorise('core.create', 'com_soundche_circle');
}
                if (!$canEdit && $user->authorise('core.edit.own', 'com_soundche_circle.circlesoundche.'.$id)) {
	...
	{
		// Get the form.
		$form = $this->loadForm('com_soundche_circle.circlesoundche', 'circlesoundcheform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	{
		$data = JFactory::getApplication()->getUserState('com_soundche_circle.edit.circlesoundche.data', array());
        if (empty($data)) {
            $data = $this->getData();
        }
