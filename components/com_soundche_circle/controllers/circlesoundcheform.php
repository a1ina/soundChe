 ...
 */
class Soundche_circleControllerCirclesoundcheForm extends Soundche_circleController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('CirclesoundcheForm', 'Soundche_circleModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_soundche_circle&view=circlesoundche&layout=edit', false));
	}
	...
	public function save()
	{
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_soundche_circle&view=circlesoundcheform&layout=edit&id='.$id, false));
			return false;
		}
