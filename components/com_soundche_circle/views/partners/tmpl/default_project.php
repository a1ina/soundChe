...
<div class="sidebar">
    <ul>
        ...
        <li>
            <a class="now" href="<?php echo JRoute::_('index.php?option=com_soundche_circle&view=partners&id=' . (int)$this->item->id.'&layout=default_project'); ?>"><?php echo JText::_("COM_SOUNDCHE_CIRCLE_PARTNERS"); ?></a>
        </li>
